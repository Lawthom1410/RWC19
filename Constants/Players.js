...
const PLAYERS = [
    ...
    Player("Freddy", "Scotland", "A", "blue-gif", -1, 0),
    Player("Louise", "Russia", "A", "red-blue", -1, 0),
    Player("Naomi", "England", "C", "england-gif", 0, 10),
    Player("George", "Canada", "B", "red", -1, 0),
    Player("Geraint", "Namibia", "B", "blue", -2, 0),
    Player("Josie", "France", "C", "blue", 0, 4),
    Player("Martine", "Samoa", "A", "blue", 3, 5),
    Player("Ian", "Fiji", "D", "blue", -1, 2),
    Player("Julian", "Argentina", "C", "blue", 0, 6),
    Player("Lee", "Italy", "B", "blue", 0, 10),
    Player("Leah", "New Zealand", "B", "blue", 0, 4),
    Player("Gary", "Japan", "A", "blue", 0, 9),
    Player("Jack", "USA", "C", "blue", -1, 0),
    Player("Joe", "Uruguay", "D", "blue", 0, 4),
    Player("Connor", "South Africa", "B", "blue", 0, 5),
    Player("Callum", "Georgia", "D", "blue", -2, 5),
    Player("Lili","Australia", "D", "blue", 0, 6),
